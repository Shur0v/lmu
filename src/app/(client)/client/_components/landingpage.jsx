...
const formatEventDateTime = (dateTime, userTimezone) => {
  try {
    // dateTime should be in ISO format or Date object
    return formatInTimeZone(dateTime, userTimezone, 'yyyy-MM-dd hh:mm aaaa');
  } catch (error) {
    return 'Invalid date';
  }
};